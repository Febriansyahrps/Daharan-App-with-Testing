const itActsAsFavoriteRestaurantModel = (favoriteRestaurant) => {
    ...
    it('should be able to search for restaurant', async () => {
        favoriteRestaurant.putRestaurant({ id: 1, name: 'cafe a' })
        favoriteRestaurant.putRestaurant({ id: 2, name: 'cafe b' })
        favoriteRestaurant.putRestaurant({ id: 3, name: 'cafe abc' })
        favoriteRestaurant.putRestaurant({ id: 4, name: 'ini mah cafe abcd' })

        expect(await favoriteRestaurant.searchRestaurants('cafe a'))
            .toEqual([
                { id: 1, name: 'cafe a' },
                { id: 3, name: 'cafe abc' },
